      ...
      <div className="hookah-container">
          ...
          <div className="md:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-montserrat font-bold text-xl text-white">
                HOOKAH<span className="text-hookah-accent">LOUNGE</span>
              </span>
            </a>
            <p className="text-hookah-light text-sm mb-4">
              Лучший кальянный ресторан с исключительной кухней, баром и
              первоклассным сервисом.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="text-hookah-light hover:text-hookah-accent transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <span className="text-hookah-light">
                  ул. Дымная, 42, Москва
                </span>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:info@hookahlounge.ru"
                  className="text-hookah-light hover:text-hookah-accent transition-colors"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="text-hookah-light hover:text-hookah-accent transition-colors text-sm"
            >
